...
export class AiAssistantMessagesTestManager {
    ...
    async createAiAssistantMessage(
        accessToken: string,
        refreshToken: string,
        data: any,
        userAgent: string,
    ...
    async updateAiAssistantMessage(
        accessToken: string,
        refreshToken: string,
        data: any,
        userAgent: string,
    ...
    async deleteAiAssistantMessageById(
        accessToken: string,
        refreshToken: string,
        msgId: string,
        deleteOption: string,
    ...
    async deleteAllAiAssistantMessages(
        accessToken: string,
        refreshToken: string,
