...
export class ShopTypesTestManager {
    ...
    async getShopTypes(
        ...
        const response = await request(this.app.getHttpServer())
            .get(`${SETTINGS.RouterPath.shoptype}`)
    ...
    async getShopTypeById(
        ...
        const response = await request(this.app.getHttpServer())
            .get(`${SETTINGS.RouterPath.shoptype}/${typeId}`)
    ...
    async createShopType(
        ...
        const response = await request(this.app.getHttpServer())
            .post(SETTINGS.RouterPath.shoptype)
            .set('Authorization', `Bearer ${accessToken}`)
            .send(shopType)
            .expect(expectedStatusCode);
    ...
    async deleteShopType(
        ...
        const response = await request(this.app.getHttpServer())
            .delete(`${SETTINGS.RouterPath.shoptype}/${typeId}`)
            .set('Authorization', `Bearer ${accessToken}`)
