...
export class Blog {
    ...
    makeDeleted() {
        const date = new Date();
        console.log('BlogEntity: - makeDeleted 😡 this.deletedAt', this.deletedAt)
        if (this.deletedAt !== null) {
            console.log('BlogEntity: - makeDeleted 😡 this.deletedAt !== null', this.deletedAt)
            throw new NotFoundException('Блог уже удален!');
            // throw new Error('Блог уже удален!');
        }
