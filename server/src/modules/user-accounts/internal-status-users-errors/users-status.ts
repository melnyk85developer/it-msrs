export const USERS_INTERNAL_STATUS = {
    ...
    NOT_FOUND_USER: 953, // Такого пользователя не найденно! 
    NOT_FOUND_CONFIRMATION_CODE: 954, // Такого кода подтверждения не найденно! 

    BAD_REQUEST_INCORECT_E_MAIL: 11937, // Не корректный email!
