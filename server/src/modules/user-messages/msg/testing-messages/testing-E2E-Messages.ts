...
export const userMessagesE2eTest = () => {
    ...
    const prepareIsCreatedDIalog = async () => {
        ...
        const { getAllInterlocutors } = await contextTests.userMessagesTestManager.getAllInterlocutors(
            contextTests.sessions.accessTokenUser1Devices[0],
            contextTests.sessions.refreshTokenUser1Devices[0],
            contextTests.constants.userAgent[1],
        ...
        await contextTests.userMessagesTestManager.deleteAllMessage(
            ...
            'me',
            contextTests.constants.userAgent[6],
            HTTP_STATUSES.NO_CONTENT_204
        )
    }
    describe('E2E-USER-MESSAGES', () => {
        beforeAll(async () => {
        ...
        //         contextTests.constants.userAgent[2],
        ...
        //         contextTests.constants.invalidId,
        //         undefined,
        //         contextTests.constants.userAgent[3],
        ...
        //         contextTests.sessions.refreshTokenUser1Devices[0],
        //         message,
        //         contextTests.constants.userAgent[4],
        //         HTTP_STATUSES.BAD_REQUEST_400
        //     )
        // })
        ...
        //         message,
        //         contextTests.constants.userAgent[5],
        ...
        //         contextTests.users.createdUsers[0]!.id,
        //         contextTests.users.createdUsers[1]!.id,
        //         contextTests.constants.userAgent[7],
        //         HTTP_STATUSES.OK_200
        //     )
        ...
        //         HTTP_STATUSES.OK_200
        //     )
        //     // console.log('TEST: - getAllInterlocutors', getAllInterlocutors[0].chat)
        //     contextTests.createdDialog1 = getAllInterlocutors[0].chat
        //     expect(getAllInterlocutors.length).toEqual(1);
        //     expect(getAllInterlocutors).toEqual(expect.arrayContaining([]));
        // })
        ...
        //         contextTests.users.createdUsers[0]!.id,
        //         contextTests.users.createdUsers[1]!.id,
        //         contextTests.constants.userAgent[9],
        //         HTTP_STATUSES.OK_200
        //     )
        //     expect(getEntity.allMsg).toEqual([
        //         {
        ...
        //         '',
        //         message,
        //         contextTests.constants.userAgent[0],
        //         HTTP_STATUSES.UNAUTHORIZED_401
        //     )
        // })
        ...
        //             read: true,
        //         },
        //         contextTests.constants.userAgent[8],
        //         HTTP_STATUSES.FORBIDDEN_403
        //     )
        ...
        //         HTTP_STATUSES.NO_CONTENT_204
        //     )
        //     // const { getEntity: getMsg } = await userMessagesTestManager.getInterlocutorById(
        //     //     contextTests.app.getHttpServer(),
        //     //     contextTests.accessTokenUser1Device1,
        //     //     contextTests.refreshTokenUser1Device1,
        //     //     contextTests.createdMessage1.dialogId,
        //     //     contextTests.createdUser1.userId,
        //     //     contextTests.createdUser2.userId,
        //     //     contextTests.userAgent[5],
        //     //     HTTP_STATUSES.OK_200
        //     // )
        ...
        //     const { getEntity } = await userMessagesTestManager.getInterlocutorById(
        //         contextTests.app.getHttpServer(),
        //         contextTests.accessTokenUser1Device1,
        //         contextTests.refreshTokenUser1Device1,
        //         contextTests.createdMessage1.dialogId,
        ...
        //             msgId: contextTests.createdMessage1.msgId,
        //             message: contextTests.createdMessage1.message,
        //             senderId: Number(contextTests.createdUser1.userId),
        //             receiverId: Number(contextTests.createdUser2.userId),
        //             read: contextTests.createdMessage2.read,
        //             dialogId: contextTests.createdMessage2.dialogId,
        //             replyToMessageId: contextTests.createdMessage2.replyToMessageId,
        //             createdAt: expect.any(String),
        ...
        //             msgId: contextTests.createdMessage2.msgId,
        //             message: contextTests.createdMessage2.message,
        //             senderId: Number(contextTests.createdUser2.userId),
        //             receiverId: Number(contextTests.createdUser1.userId),
        //             read: contextTests.createdMessage2.read,
        //             dialogId: contextTests.createdMessage2.dialogId,
        //             replyToMessageId: contextTests.createdMessage2.replyToMessageId,
        //             createdAt: expect.any(String),
        ...
        //     await userMessagesTestManager.deleteAllMessage(
        //         contextTests.app.getHttpServer(),
        //         undefined,
        //         null,
        //         {
        //             senderId: contextTests.createdUser1.userId,
        //             receiverId: contextTests.createdUser2.userId,
        //         },
        //         'all',
        //         contextTests.userAgent[6],
        //         HTTP_STATUSES.UNAUTHORIZED_401
        //     )
        //     const { response } = await userMessagesTestManager.getInterlocutorById(
        //         contextTests.app.getHttpServer(),
        //         contextTests.accessTokenUser1Device1,
        //         contextTests.refreshTokenUser1Device1,
        //         contextTests.createdMessage1.dialogId,
        ...
        //     const { response: res } = await userMessagesTestManager.deleteAllMessage(
        //         contextTests.app.getHttpServer(),
        //         contextTests.accessTokenUser1Device1,
        //         contextTests.refreshTokenUser1Device1,
        //         {
        ...
        //     const { response } = await userMessagesTestManager.deleteAllMessage(
        //         contextTests.app.getHttpServer(),
        //         contextTests.accessTokenUser1Device1,
        //         contextTests.refreshTokenUser1Device1,
        //         {
