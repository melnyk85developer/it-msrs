import { DialogAiAssistantDocument } from "src/modules/admin/ai-assistant/ai-assistant-chats/ai-assistant-dialog/ai-assistant-dialog-domain/ai-assistant-dialog-entity";
