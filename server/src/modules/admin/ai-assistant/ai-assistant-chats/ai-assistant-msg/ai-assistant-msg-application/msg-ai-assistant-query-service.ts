...
import { queryMaperUserMessage } from '../../ai-assistant-maper/queryMaper';
...
export class MessageAiAssistantQueryService {
    ...
    async getAllAiAssistantMessagesByDialogIdService(userId: string, dialogId: string, query: GetAiAssistantMessageQueryParams): Promise<PaginatedViewDto<AiAssistantMessageViewDto[]>> {
    ...
    async getMessageByIdOrNotFoundFailQueryService(msgId: string, userId: string): Promise<AiAssistantMessageViewDto> {
        ...
        return AiAssistantMessageViewDto.mapToMessagesAiAssistantAllView(filtered);
    }
