...
import { SHOP_INTERNAL_STATUS } from "./shops-status"
...
export const SHOP_ERRORS = {
    // SHOP TYPE
    [SHOP_INTERNAL_STATUS.FORBIDDEN_SHOP_TYPES_UPDATE]: {
        messages: { message: 'Вы не являетесь владельцем записи для её обновления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    [SHOP_INTERNAL_STATUS.FORBIDDEN_SHOP_TYPES_DELETE]: {
        messages: { message: 'Вы не являетесь владельцем записи для её удаления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    // SHOP BRAND
    [SHOP_INTERNAL_STATUS.FORBIDDEN_SHOP_BRAND_UPDATE]: {
        messages: { message: 'Вы не являетесь владельцем записи для её обновления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    [SHOP_INTERNAL_STATUS.FORBIDDEN_SHOP_BRAND_DELETE]: {
        messages: { message: 'Вы не являетесь владельцем записи для её удаления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    // MERCHANDISE 
    [SHOP_INTERNAL_STATUS.FORBIDDEN_MERCHANDISE_UPDATE]: {
        messages: { message: 'Вы не являетесь владельцем товара для его обновления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    [SHOP_INTERNAL_STATUS.FORBIDDEN_MERCHANDISE_DELETE]: {
        messages: { message: 'Вы не являетесь владельцем товара для его удаления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    // MERCHANDISE_TYPE
    [SHOP_INTERNAL_STATUS.FORBIDDEN_MERCHANDISE_TYPE_UPDATE]: {
        messages: { message: 'Вы не являетесь владельцем типа товара для его обновления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    [SHOP_INTERNAL_STATUS.FORBIDDEN_MERCHANDISE_TYPE_DELETE]: {
        messages: { message: 'Вы не являетесь владельцем типа товара для его удаления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    // MERCHANDISE_BRAND
    [SHOP_INTERNAL_STATUS.FORBIDDEN_MERCHANDISE_BRAND_UPDATE]: {
        messages: { message: 'Вы не являетесь владельцем бренда товара для его обновления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    [SHOP_INTERNAL_STATUS.FORBIDDEN_MERCHANDISE_BRAND_DELETE]: {
        messages: { message: 'Вы не являетесь владельцем бренда товара для его удаления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    // SHOP 
    [SHOP_INTERNAL_STATUS.FORBIDDEN_SHOP_UPDATE]: {
        messages: { message: 'Вы не являетесь магазина для его обновления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    [SHOP_INTERNAL_STATUS.FORBIDDEN_SHOP_DELETE]: {
        messages: { message: 'Вы не являетесь магазина для его удаления!', field: 'shops' },
        statusCode: HTTP_STATUSES.FORBIDDEN_403,
    },
    // SHOP 
