...
export const mailResendingEmailMessageHTMLDocument = (nameProjekt: string, to: string, text: any, link: string) => {
    return (`
    <section style="
        margin: 0;
        padding: 10px;
            ...
            ">
                <strong 
                    style="
                        ...
                        font-style: italic;
                ">
                Если Вы не инициировали повторную отправку этого письма, 
                для завершения регистрации на проекте ${nameProjekt}, то это 
                может означать: 
                </strong><br/>
            </p                 
                style="
            ...
            ">
                ...
                <span 
                    style="
                        ...
                        font-size: 0.875rem;;
                        color: #ff6600;
                ">${to}${' '}</span>до выяснения!)</strong><br/>
