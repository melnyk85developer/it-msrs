...
import UpdatePostForBlogFormModal from "../ModalPostForm/FormUpdatePostForBlog/formUpdateBlog";
...
const PostItemForBlog: React.FC<PropsType> = React.memo(({ post, isDarkTheme }) => {
    ...
    const updatePost = () => {
        const updatedPost = {
            ...
            content,
            blogId: myCurrentPost.id // ERRORRRRR
        }
...
export default PostItemForBlog;