...
import DeviceDetail from '../MerchandiseDetail';
...
import { Merchandise, MyBasket, MyShopsType } from '@packages/shared/src/types/shopsTypes';
...
const MerchandiseItem: React.FC<PropsType> = React.memo(({
    merchandiseId, name, price, rating, image, shop, basket, authorizedUser, click_brandId, click_typeId, click_deviceId, page, setModalActiveBasket, dispatch}) => {
    ...
    return (
        <div className={classes.wrapItemDevice} style={click_deviceId === merchandiseId ? {borderColor: "#FFAC00"}: undefined} ref={dropdownRef}>
